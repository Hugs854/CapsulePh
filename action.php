...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='aside'>
							<h3 class='aside-title'>Pharmacy</h3>
							<div class='btn-group-vertical'>
	";
	if(mysqli_num_rows($run_query) > 0){
        $i=1;
                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									<div class='product-img'>
										<img src='product_images/$pro_image' style='height: 260px;' alt=''>
										
									</div></a>
									<div class='product-body' >
										<p class='product-category'>$cat_name</p>
										<h3 class='product-name header-cart-item-name' style='height: 50px;'><a href='product.php?p=$pro_id'>$pro_title </a></h3>
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
            ...
            echo '<div class="cart-summary">
				    ...
				    <h5>PHP '.number_format($total_price, 2).'</h5>
				</div>'
            ?>
						...
						<tr>
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-4 "><img src="product_images/'.$product_image.'" style="height: 100px;width:100px;"/>
