	...
	<th><a href="addsuppliers.php" class="btn btn-success">Add New</a></th>
                    ...
                    <tbody>
                      <?php 
                        ...
                        <a class='btn btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='manageuser.php?user_id=$user_id&action=delete'>Delete<div class='ripple-container'></div></a>
                        </td></tr>";
                        }
                        mysqli_close($con);
                        ?>
