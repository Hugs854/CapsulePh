      ...
      <div class="content">
		...
		<a>
          ...
          <div class='alert alert-success'>
            ...
            if(isset($_POST['catsuccess'])) {
              $success = $_POST["catsuccess"];
              echo "<div class='col-md-12 col-xs-12' id='product_msg'>
            <div class='alert alert-success'>
              <a href='#'' class='close' data-dismiss='alert' aria-label='close'>×</a>
              ...
              if(isset($_POST['pharsuccess'])) {
                $success = $_POST["pharsuccess"];
                echo "<div class='col-md-12 col-xs-12' id='product_msg'>
              <div class='alert alert-success'>
                <a href='#'' class='close' data-dismiss='alert' aria-label='close'>×</a>
                <b>PHARMACY ADDED SUCCESSFULLY!</b>
              </div>
            </div>";
                }
            ?></a>
          ...
          <div class="col-md-6">
           ...
           <div class="col-md-5">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Administrator(s)</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <?php 
                        ...
                        while(list($brand_id,$brand_title,$admin_email)=mysqli_fetch_array($result))
                        {	
                        echo "<tr><td>$brand_title</td><td><a href='mailto:$admin_email'>$admin_email</a></td>
