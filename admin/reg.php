            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="post" class="register-form" id="register-form" action="login.php">
                            ...
                            <div class="form-group">
                                ...
                                <input class ="nameinput" type="text" name="admin_name" id="name" placeholder="Your Full Name"/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="login.php" class="signup-image-link">I already have an Admin Account</a>
                    </div>
                </div>
            </div>
        </section>
