...
if (isset($_POST['re_password']))
  ...
  $password_query = mysqli_query($con,"select * from seller_info where seller_email='$email'");
  $password_row = mysqli_fetch_array($password_query);
  $database_password = $password_row['seller_password'];
  if ($database_password == $op)
    {
    if ($new_pass == $re_pass)
      {
        $pass = md5($re_pass);
      $update_pwd = mysqli_query($con,"UPDATE seller_info set seller_password='$pass' where seller_id='6'");
                      ...
                      <div class="col-md-5">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">
                            <?php  if (isset($_SESSION['seller_name'])) : ?><?php echo $_SESSION['seller_name']; ?>
             <?php endif ?>
