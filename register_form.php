						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input class="nameinput form-control input-borders" type="text" name="f_name" id="f_name" placeholder="First Name">
                                    </div>
                                    <div class="form-group">
                                    
                                        <input class="nameinput form-control input-borders" type="text" name="l_name" id="l_name" placeholder="Last Name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <center><a href="" data-toggle="modal" data-target="#Modal_login" class="close" data-dismiss="modal">Already have an Account? Login</a></center>
